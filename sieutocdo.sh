...
makeConfig() {
    echo "------  SIEUTOCDO & FAST4G.NET ---------"
	read -p "Loại website của bạn: V2board"
	echo "---------------"
	read -p "Link website: https://sieutocdo.net/"
	echo "---------------"
	read -p "API key của web: adminsieutocdo123@gmail.com"
	echo "---------------"
...
Nodes:
  -
    PanelType: "V2board" 
    ApiConfig:
      ApiHost: "https://apibimat-oksub123ab.sieutocdo.net"
      ApiKey: "adminsieutocdo123@gmail.com"
      NodeID: $NodeID80
      NodeType: V2ray 
      Timeout: 30 
      EnableVless: false 
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-sieutocdo/crt.crt 
        KeyFile: /etc/XrayR/cert-sieutocdo/key.key
        Provider: alidns 
        Email: test@me.com
        DNSEnv: 
...
EOF
	cd /etc/XrayR
	git clone https://github.com/chaomynhan/cert-sieutocdo.git
	XrayR restart
